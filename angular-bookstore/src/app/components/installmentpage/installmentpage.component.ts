...
@Component({
  selector: 'app-installmentpage',
  templateUrl: './installmentpage.component.html',
  styleUrls: ['./installmentpage.component.css']
})
export class InstallmentpageComponent implements OnInit {
  cartItems: CartItem[] = [];
  totalPrice: number = 0;
